...
For Each varialbe is it categorical or continuous?
...
CSV_FILE <- paste(working_directory, "/", "raw_data/IHME-GBD_2021_DATA-dcd5bf12-1.csv", sep = "")
...
ihme_raw_df = read.csv(CSV_FILE, stringsAsFactors = TRUE)
